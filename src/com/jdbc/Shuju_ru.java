...
public class Shuju_ru {
	static Connection lianjie=null;
	public static void main(String[] args) throws Exception {
		Class.forName("com.mysql.jdbc.Driver");
		//通过驱动获取连接连接对象
		lianjie= DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/rj182?characterEncoding=utf8","root","123456");
	...
	private static void read_xlsx_and_write_to_db(File file) throws Exception{
		...
		for (int i=1;i<=rows;i++) {
			...
			//读取这个单元格的值
			String you_shili=cell20.getStringCellValue();
			String zuo_shili=cell21.getStringCellValue();
